...
def main():
    ...
    parser.add_argument("--dataset_path", type=str, help="Path to the datafolder")
    parser.add_argument("--model_file_path", type=str, help="Path to save the model after training and load it before testing.")
    ...
    if args.mode == "train":
        ...
        if not args.dataset_path  or not args.model_file_path:
            parser.error("Training mode requires --dataset_path, and --model_file_path")
